...
export default function Chat() {
  ...
  return (
    <div className="flex flex-col w-full py-24 justify-center items-center">
          ...
          >
            <div
              className={cn(
                ...
                message.role === "user"
                  ? brandColors.chat.userBubble
                  : brandColors.chat.botBubble,
              )}
            >
      ...
      >
        <div className="flex flex-col gap-2 justify-center items-start mb-8 max-w-xl w-full border p-2 rounded-lg bg-card">
          <Input
